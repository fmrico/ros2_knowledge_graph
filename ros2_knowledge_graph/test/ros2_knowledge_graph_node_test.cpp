...
public:
  ...
  explicit GraphTest(rclcpp_lifecycle::LifecycleNode::SharedPtr provided_node)
  : GraphNode(provided_node)
  {}
...
TEST(ros2_knowledge_graphnode, lc_graph_comms_factory)
{
  auto node1 = rclcpp_lifecycle::LifecycleNode::make_shared("test_node_1");
  auto node2 = rclcpp_lifecycle::LifecycleNode::make_shared("test_node_2");

  rclcpp::executors::SingleThreadedExecutor exe;
  exe.add_node(node1->get_node_base_interface());
  exe.add_node(node2->get_node_base_interface());
  ...
  node1->trigger_transition(lifecycle_msgs::msg::Transition::TRANSITION_CONFIGURE);
  node2->trigger_transition(lifecycle_msgs::msg::Transition::TRANSITION_CONFIGURE);
  {
    auto start = node1->now();
    while ((node1->now() - start).seconds() < 0.1) {}
  }
  node1->trigger_transition(lifecycle_msgs::msg::Transition::TRANSITION_ACTIVATE);
  node2->trigger_transition(lifecycle_msgs::msg::Transition::TRANSITION_ACTIVATE);
...
TEST(ros2_knowledge_graphnode, lc_graph_operations)
{
...
TEST(ros2_knowledge_graphnode, lc_graph_comms)
{
  auto node1 = rclcpp_lifecycle::LifecycleNode::make_shared("test_node_1");
  auto node2 = rclcpp_lifecycle::LifecycleNode::make_shared("test_node_2");
...
TEST(ros2_knowledge_graphnode, lc_graph_comms_tf)
{
  auto node1 = rclcpp_lifecycle::LifecycleNode::make_shared("test_node_1");
  auto node2 = rclcpp_lifecycle::LifecycleNode::make_shared("test_node_2");
...
TEST(ros2_knowledge_graphnode, lc_graph_stress)
{
  auto node1 = rclcpp_lifecycle::LifecycleNode::make_shared("test_node_1");
  node1->trigger_transition(lifecycle_msgs::msg::Transition::TRANSITION_CONFIGURE);
  rclcpp::spin_some(node1->get_node_base_interface());
  node1->trigger_transition(lifecycle_msgs::msg::Transition::TRANSITION_ACTIVATE);
  rclcpp::spin_some(node1->get_node_base_interface());
...
TEST(ros2_knowledge_graphnode, lc2_graph_comms_factory)
{
  auto node1 = rclcpp_lifecycle::LifecycleNode::make_shared("test_node_1");
  auto node2 = rclcpp_lifecycle::LifecycleNode::make_shared("test_node_2");
...
TEST(ros2_knowledge_graphnode, combined_graph_comms_factory)
{
  auto node1 = rclcpp::Node::make_shared("test_node_1");
  auto node2 = rclcpp_lifecycle::LifecycleNode::make_shared("test_node_2");
