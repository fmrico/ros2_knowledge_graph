...
bool
Graph::can_add_node(const Node & node)
{
...
bool
Graph::can_remove_node(const std::string node)
{
...
bool
Graph::can_add_edge(const Edge & edge)
{
...
bool
Graph::can_remove_edge(const Edge & edge)
{
